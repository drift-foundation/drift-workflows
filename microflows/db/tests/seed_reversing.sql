...
-- schema. Lives under db/tests/ (the Mariachi schema apply only loads db/schema +
-- db/procs), and is loaded into the test database ONLY by the test gate
-- (_db-load-test-fixtures). It seeds a CLAIMABLE reversing(2) workflow with one
